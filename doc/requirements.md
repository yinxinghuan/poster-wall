...
- 顶部信息区高度约 96px，左右各 22px。左侧为 184px × 78px 黄色切角导视牌，clip-path 为右上和左下切角，显示 9px `POSTER WALL`、42px Impact/Arial Black 标题 `TONIGHT`、10px `WALL / MINE {n}`；右侧为 130px × 78px 的竖向 `STACK / GRID` 切角切换牌，选中态蓝底奶白字并左移 5px。
