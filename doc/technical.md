...
- 界面风格：`PosterWall.less` 使用深黑 `#151515`、奶白 `#eee7d5`、黄色 `#ffe100`、蓝色 `#2457e6`、红色 `#f31313`、深绿 `#17664b` 和青色 `#4dcfe8`。顶部 `.pw-header__copy` 是黄色切角导视牌，右侧 `.pw-view-toggle` 是竖向 `STACK / GRID` 切角按钮；底部 `.pw-generator` 保持克制，`.pw-cta` 是黄色切角 `MAKE POSTER` 标牌。
